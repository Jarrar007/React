...
const BookCard = ({img,title,date,pages,description,book_link}) => {
...
<div className="w-42 h-36 bg-slate-400 mb-2 bg-center bg-cover" style={{backgroundImage:`url("${img}")`}}></div>
...
<>
 ...
 <a href={book_link} download="newfilename"><button className="text-center rounded-lg bg-green-600 w-24 h-8 mt-2 text-white font-bold hover:bg-green-800" >Download</button></a>
 </>
