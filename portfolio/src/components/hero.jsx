  ...
  return (
    <div className='w-full mt-[100px]'>
        <div className='flex flex-col gap-4 items-center'>
            ...
            <motion.h2 initial = {{y : 50 , opacity : 0,scale:0.25}} animate = {{y : 0, opacity : 1,scale:1}} transition={{duration : 1.5, delay : 1.5}} className='flex flex-wrap mt-[10px] text-2xl text-center bg-gradient-to-r text-transparent from-yellow-500 via-green-400 to-red-500 bg-clip-text' >FullStack Developer</motion.h2>
